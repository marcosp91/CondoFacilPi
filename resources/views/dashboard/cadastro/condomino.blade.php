...
<?php if (!isset($_SESSION)) {session_start();}?>
    ...
    @section('content')
              ...
              <div class="panel-body">
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <button type="button" class="btn-acess btn btn-warning"  style=" float:right;" data-toggle="modal" data-target="#modal-mensagem"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Novo Condômino</button>
      ...
      <div class="modal fade" id="modal-mensagem">
         ...
         <div id="lista" class="col-xs-12 col-md-8 collapse"><!-- Coluna Painel Form -->
        <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
                <h3 class="panel-title"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Cadastar Área Comum</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{route('area.cadastro')}}">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12{{ $errors->has('nome') ? ' has-error' : '' }}">
                            ...
                            <input type="text" id="nomeAreaComum" name="nome" class="form-control" value="{{ old('nome') }}" required>
                            @if ($errors->has('nome'))
                            <span class="help-block">
                                <strong>{{ $errors->first('nome') }}</strong>
                            </span>
