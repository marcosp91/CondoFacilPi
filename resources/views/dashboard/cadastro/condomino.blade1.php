...
<?php if (!isset($_SESSION)) {session_start();}?>
    ...
    @section('content')
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-xs-6 col-md-5{{ $errors->has('endereco') ? ' has-error' : '' }}">
                                   ...
                                   <div class="col-xs-6 col-md-2{{ $errors->has('bloco') ? ' has-error' : '' }}">
                                      ...
                                      <input type="text" id="blocoUsuario" name="bloco" class="form-control" placeholder="Bloco" value="{{$_SESSION['usuario']->bloco}}"/>
                                      @if ($errors->has('bloco'))
                                      <span class="help-block">
              ...
              <div class="col-xs-12 col-md-6">
                  ...
                  <div class="panel panel-default">
                      <div class="panel-heading main-color-bg">
                          <h3 class="panel-title">Condôminos</h3>
                      </div>
                      <div class="panel-body">
                          <div class="row">
                              <div class="col-md-12">
                          ...
                          <table class="table table-hover table-responsive">
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td><a class="btn btn-default" href="edit.html">Editar</a> <a class="btn btn-danger" href="#">Deletar</a></td>
                                  </tr>
                              </tbody>
                          </table>
                      </div><!-- Painel Body -->
